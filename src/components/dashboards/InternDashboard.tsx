...
const InternDashboard = ({ onBack }: InternDashboardProps) => {
              ...
              <CardContent className="space-y-4">
                ...
                <div className="space-y-2 text-sm">
                  <div className="flex items-center space-x-2">
                    ...
                    <span>Academic Records Added</span>
                  </div>
                  <div className="flex items-center space-x-2">
                    <div className="h-2 w-2 bg-green-500 rounded-full"></div>
                  ...
                  <div className="flex items-center space-x-2">
                    ...
                    <span>Portfolio Projects Missing</span>
                  </div>
                </div>
              ...
              <CardContent className="space-y-3">
                <div className="flex items-center space-x-3">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-slate-600">Criminal Procedure Code</p>
                  </div>
                </div>
                <div className="flex items-center space-x-3">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-slate-600">Legal Research Quiz</p>
                  </div>
                </div>
              </CardContent>
            </Card>
